        ...
        appBar: AppBar(
          ...
          title: Row(
            ...
            children: [
              ...
              Switch.adaptive(
                value: FFAppState().OScopeState[1],
                onChanged: (newValue) async {
                  if (FFAppState().device!=null){
                    safeSetState(() => FFAppState().OScopeState[1] = newValue);
                  }
                  if (FFAppState().device != null  && FFAppState().OScopeState[1]==true) {
                    
                    FFAppState().appState = 2;
                  ...
                  else if (FFAppState().OScopeState[1]==false){
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                    itemCount: FFAppState().I2CData.length,
                    itemBuilder: (context, index) {
                      final row = FFAppState().I2CData[index];
                      return Padding(
